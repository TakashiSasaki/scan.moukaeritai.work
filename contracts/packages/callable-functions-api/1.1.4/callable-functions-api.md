# Callable Functions API Contract (v1.1.4)
...
* **Idempotency**: Strict idempotency is fully supported via UUIDv7 commandId verification.
...
* **Request Payload Schema**:
  ...
  interface BaseSubmitRequest {
    commandId: string; // Client-provided unique request identifier (strictly UUIDv7 format)
  }
