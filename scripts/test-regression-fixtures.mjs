...
const requiredRunners=['sha256-known-vector','callable-schema-validation','participant-index','submit-fact-idempotency','association-transition','query-index-mutation','documentation-mutation','version-governance-mutation','stride-manifest-mutation'];
