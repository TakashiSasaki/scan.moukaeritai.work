...
This document is the canonical source for the `scan.mw` database structure explanation. It describes both the current production runtime schema and the target Entity / Fact / Projection model.
