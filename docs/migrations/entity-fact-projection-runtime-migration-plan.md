...
- The first-class shared EFP package has been introduced. Backend/admin projection recompute remains blocked until Functions consumption of the package is explicitly validated in the deployment boundary.
