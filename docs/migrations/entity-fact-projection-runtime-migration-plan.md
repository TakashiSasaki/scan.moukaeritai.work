...
- The first-class shared EFP package has been introduced. The shared EFP package now emits build artifacts. Backend/admin projection recompute remains blocked until Functions consumption of the package is explicitly validated inside the Firebase Functions deployment boundary.
