...
This document defines the proposed data model for `scan.mw` after moving away from an Identifier/Binding-centered model toward an Entity/Fact/Projection model.
