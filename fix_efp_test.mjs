...
const replacement = `  test("sha256 implementation exact match with Node crypto (including UTF-8)", async () => {
...
content = content.replace(/  test\("Marker key hashing for non-ASCII defaults to UTF-8 SHA-256 issue".*?\s*\/\/ TODO: Verify if the pure JS sha256 matches node crypto exactly for non-ASCII\s*\}\);/s, replacement);
