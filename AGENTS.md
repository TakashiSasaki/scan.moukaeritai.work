...
- The `projection-backfill-design-gate` GitHub Actions workflow automates the local-only execution design gate assessment. It explicitly forbids Firebase credentials, OIDC, network writes, or runtime deployments, strictly operating within the checked-in fixture evidence bounds.
