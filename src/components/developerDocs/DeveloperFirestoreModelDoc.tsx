    ...
    <div className="p-3 md:p-4 lg:p-6 w-full max-w-none mx-0 space-y-8 pb-24">
      <section className="bg-[var(--surface-container)] rounded-3xl p-6 border border-[var(--outline)]">
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-4 flex gap-3 text-sm">
          ...
          <p className="text-[var(--on-surface)]">
            This page is purely static documentation and does not query or inspect live database environments. Runtime behavior still depends on legacy/current collections until migration phases are implemented.
          </p>
        </div>
      </section>
      ...
      <div className="space-y-6">
        <section className="bg-[var(--surface-container)] border border-[var(--outline)] rounded-2xl p-6">
          <h3 className="text-lg font-bold text-[var(--on-surface)] mb-4">Current Runtime Collections</h3>
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <p className="text-sm text-[var(--on-surface)]">
                Stores the physical asset. Denormalizes related data like <code>identifierSummary</code> and <code>primaryImageUrl</code> for read efficiency. Fully active.
              </p>
            </div>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <p className="text-sm text-[var(--on-surface)]">
                Time-series log of identifier sightings.
              </p>
            </div>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <p className="text-sm text-[var(--on-surface)]">
                Append-only operational log recording object lifecycle and modifications.
              </p>
            </div>

            <div className="border-l-4 border-blue-500 pl-4">
              <h4 className="font-bold text-[var(--primary)] text-md">objectImages</h4>
              <p className="text-xs text-[var(--on-surface-variant)] mb-2"><strong>ID:</strong> Generated UUIDv4.</p>
              <p className="text-sm text-[var(--on-surface)]">
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h4 className="font-bold text-[var(--primary)] text-md">items</h4>
              <p className="text-xs text-[var(--on-surface-variant)] mb-2"><strong>Status:</strong> Legacy Compatibility</p>
              <p className="text-sm text-[var(--on-surface)]">
                The original flat structure containing embedded properties, tags, and images. Legacy import source only.
              </p>
            </div>
        ...
        <section className="bg-[var(--surface-container)] border border-[var(--outline)] rounded-2xl p-6">
          ...
          <p className="text-sm text-[var(--on-surface-variant)] mb-4">These represent the target migration destination for timeless identity nodes.</p>
          <ul className="space-y-2 text-sm text-[var(--on-surface)] list-disc pl-5">
            ...
            <li><strong>places:</strong> Migration target for spatial zones.</li>
          </ul>
        </section>

        <section className="bg-[var(--surface-container)] border border-[var(--outline)] rounded-2xl p-6">
          <h3 className="text-lg font-bold text-[var(--on-surface)] mb-4 text-emerald-500">Target Fact Collections</h3>
          <p className="text-sm text-[var(--on-surface-variant)] mb-4">These represent the target migration destination for temporal operational history.</p>
          <ul className="space-y-2 text-sm text-[var(--on-surface)] list-disc pl-5">
            ...
            <li><strong>measurements:</strong> Migration target for spatial/telemetry logs.</li>
            <li><strong>events:</strong> Migration target (currently implemented as <code>objectEvents</code>).</li>
          </ul>
        </section>

        <section className="bg-[var(--surface-container)] border border-[var(--outline)] rounded-2xl p-6">
          <h3 className="text-lg font-bold text-[var(--on-surface)] mb-4 text-emerald-500">Target Projection Collections</h3>
          <p className="text-sm text-[var(--on-surface-variant)] mb-4">These represent the target migration destination for derived read models.</p>
          <ul className="space-y-2 text-sm text-[var(--on-surface)] list-disc pl-5">
            <li><strong>objectSummaries:</strong> Derived read model.</li>
            <li><strong>markerSummaries:</strong> Derived read model.</li>
            <li><strong>placeSummaries:</strong> Derived read model.</li>
          </ul>
        </section>
        ...
        <section className="bg-[var(--surface-container)] border border-[var(--outline)] rounded-2xl p-6">
          ...
          <ul className="space-y-3 text-sm text-[var(--on-surface-variant)]">
            ...
            <li><strong>Missing ownerId:</strong> Identifiers without an <code>ownerId</code> are still rejected by current write rules.</li>
            ...
            <li><strong>Global Identifier Collections:</strong> Collections for <code>globalIdentifiers</code> or <code>identifierClaims</code> are historical/future design concepts and are not implemented.</li>
          </ul>
        </section>
