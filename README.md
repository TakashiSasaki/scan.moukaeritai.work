...
Welcome to **scan.mw v2.0.0**, a cloud-based item tracking and inventory management application redesigned and rebuilt using a modern **Contract-First Baseline**. 

This repository enforces backward-incompatible, robust schemas, strict version governance, and a registry-first workflow.

---

## 🏗️ Core Architecture & v2.0.0 Paradigm
...
- **Zero Backwards-Compatibility Bloat**: v2.0.0 represents a clean break from old v1 patterns. Legacy migration schemas are stored for read-only historical lookup, and live transactions strictly adhere to v2.0.0 JSON contracts.
